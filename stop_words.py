...
filtered_words_en = [word for word in text_list if word.lower() not in stop_words_eng]
print(f"filtered_words_en: {filtered_words_en}")
...
# stop words listesini olustur
tr_stopwords = ["için", "bu", "ile", "mu", "mi", "özel"]

# ornek turkce metin
metin = "Bu bir denemedir. Amacimiz bu metinde bulunan özel karakterleri temizlemek mi acaba?"
