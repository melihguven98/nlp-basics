...
# Princible Componenet Analysis: Verideki boyutlari azaltarak onemli bilgileri koruyan, yeni ozellik seti olusturan bir yontemdir. 
# Verideki varyansı en iyi sekilde aciklayan yeni dogrusal bilesenler pc'lar olusturarak yapabilir.
# Dimension Reduction - (Boyut indirgemesi)

from gensim.models import Word2Vec, FastText
from gensim.utils import simple_preprocess

# ornek veriseti olustur
sentences = [
